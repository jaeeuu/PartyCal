...
export const shareStyles = stylex.create({
  ...
  interact: {
    willChange: "transform",
    transition: {
      default: "background-color 0.3s linear, transform 0.8s var(--spring-easing)",
      ":active": "background-color 0.3s linear, transform 0.3s ease",
      "@media (hover: none)": "background-color 0.3s linear, transform 0.8s var(--spring-mobile)",
    },
    backgroundColor: {
      default: "#fafafa",
      ":not(:active):hover": {
